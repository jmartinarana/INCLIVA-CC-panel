...
fis <- read.csv2("/home/jmartin/Documents/articulo2/scripts/input_FIG1.csv", header =F, dec='.', sep=',')
nofilter <- fis[,2:4]
...
tiff(file = "/home/jmartin/Documents/articulo2/scripts/FIG1A.tiff", height = 18, width = 35, units = 'cm', res = 300)
